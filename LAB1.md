...
👉 **[Complete Prerequisites →](prerequisite.md)**
...
Open Bob and paste this prompt:
```
Generate a complete Python file called app.py for a Streamlit web application named "AI Expense Tracker".
...
### Start the App ( You can always ask Bob to do that for you 😊)
 
 Or do it in your terminal
```bash
